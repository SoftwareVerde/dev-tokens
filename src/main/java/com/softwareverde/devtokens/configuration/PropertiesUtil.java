...
public class PropertiesUtil {
    ...
    public static List<NodeProperties> parseNodeProperties(final String propertyName, final Integer defaultNetworkPort, final String defaultValue, final Properties properties) {
